                ...
                <div class="col-md-3">
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <img class="profile-user-img img-responsive img-circle" src="{{ asset('assets/img/company/').'/'.$recruiter->profilephoto}}" alt="User profile picture">
